 ...
 * @author Heimys
 */
public class ctrCatBien implements ActionListener, KeyListener{
    ...
    public ctrCatBien(CatBien catBien) {
   ...
   ////////////////////////
    ...
    public void eventobusqueda(String valor, JTable tabEstudiante, int ptipo) throws SQLException {
        ...
        if(informacion == null){
            ...
            DefaultTableModel model = new DefaultTableModel(null, new String[]{"NOMBRE","SERIAL", "MARCA","TIPO BIEN","CANTIDAD"});
           catBien.getTabCatalago().setModel(model);
        }else{
            System.out.println("LISTADO BIEN");
            DefaultTableModel model = new DefaultTableModel(informacion, new String[]{"NOMBRE","SERIAL", "MARCA","TIPO BIEN","CANTIDAD"});
            catBien.getTabCatalago().setModel(model);
        }
