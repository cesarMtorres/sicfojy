...
import controlador.ctrCatPrograma;
 ...
 * @author betty
 */
public class CatPrograma extends javax.swing.JDialog {

    /**
     * Creates new form CatPrograma
     */
    Programa vista;
        public static int salida = 0;
        public static String campobus = "nombre";
        ctrCatPrograma c = new ctrCatPrograma(this);
    public CatPrograma(java.awt.Frame parent, boolean modal)throws SQLException {
        super(parent, modal);
        initComponents();
...
//         tablaConsulta.setDefaultRenderer (Object.class, new AvisoStockMin());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CÁTALOGO PROGRAMA");
        ...
        c = new controlador.ctrCatPrograma(this);
 ...
 private void closeDialog(java.awt.event.WindowEvent evt) {                             
    ...
    private void txtBuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscarKeyReleased
            ...
            Logger.getLogger(CatPrograma.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CatPrograma.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                CatPrograma dialog = null;
                try {
                    dialog = new CatPrograma(new javax.swing.JFrame(), true);
                } catch (SQLException ex) {
                    Logger.getLogger(CatPrograma.class.getName()).log(Level.SEVERE, null, ex);
                }
