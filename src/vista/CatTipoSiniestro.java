...
import controlador.ctrCatTipoSiniestro;
 ...
 * @author Ronal
 */
public class CatTipoSiniestro extends java.awt.Dialog {
    /**
     ...
     */
        ...
        ctrCatTipoSiniestro c = new ctrCatTipoSiniestro(this);
        
    public CatTipoSiniestro(java.awt.Frame parent, boolean modal)throws SQLException {
        super(parent, modal);
        initComponents();
...
//         tablaConsulta.setDefaultRenderer (Object.class, new AvisoStockMin());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CÁTALOGO TIPO SINIESTRO");
        ...
        c = new controlador.ctrCatTipoSiniestro(this);
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(78, 78, 78)
                                .addComponent(etiBuscar, javax.swing.GroupLayout.PREFERRED_SIZE, 84, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void txtBuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscarKeyReleased
            ...
            Logger.getLogger(CatTipoSiniestro.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                CatTipoSiniestro dialog = null;
                try {
                    dialog = new CatTipoSiniestro(new javax.swing.JFrame(), true);
                } catch (SQLException ex) {
                    Logger.getLogger(CatTipoSiniestro.class.getName()).log(Level.SEVERE, null, ex);
                }
