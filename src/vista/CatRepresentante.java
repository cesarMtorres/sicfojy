 ...
 * @author Ronal
 */
public class CatRepresentante extends java.awt.Dialog {
    /**
    ...
    public CatRepresentante(java.awt.Frame parent, boolean modal)throws SQLException {
        super(parent, modal);
        initComponents();
...
//         tablaConsulta.setDefaultRenderer (Object.class, new AvisoStockMin());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CATÁLOGO DE REPRESENTANTE");
        ...
        c = new controlador.ctrCatRepresentante(this);
    ...
    private void txtBuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscarKeyReleased
            ...
            Logger.getLogger(CatRepresentante.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
            ...
            @Override
            public void run() {
                CatRepresentante dialog = null;
                try {
                    dialog = new CatRepresentante(new javax.swing.JFrame(), true);
                } catch (SQLException ex) {
                    Logger.getLogger(CatRepresentante.class.getName()).log(Level.SEVERE, null, ex);
                }
