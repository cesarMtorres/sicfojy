...
import controlador.ctrTipoSiniestro;
 ...
 * @author abe
 */
public class TipoSiniestro extends javax.swing.JDialog {
    ctrTipoSiniestro c;
     ...
     * @param modal
     */
    public TipoSiniestro(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Tipo Siniestro");
        ...
        c=new controlador.ctrTipoSiniestro(this);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TipoSiniestro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        /* Create and display the dialog */
         java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
               new TipoSiniestro(new javax.swing.JFrame(), true).setVisible(true);
            }
        });
    }
