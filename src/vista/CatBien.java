 ...
 * @author Ronal
 */
public class CatBien extends java.awt.Dialog {
    /**
     ...
     */
        ...
        public static String campobus = "nombreb";
        ctrCatBien c = new ctrCatBien(this);
        
    public CatBien(java.awt.Frame parent, boolean modal)throws SQLException
    {
        super(parent, modal);
        initComponents();
//         tablaConsulta.setDefaultRenderer (Object.class, new AvisoStockMin());
    ...
    private void initComponents() {
        ...
        c = new controlador.ctrCatBien(this);
    ...
    private void buscapor2ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_buscapor2ItemStateChanged
        ...
        if (buscapor2.isSelected()) {
            try {
                ...
                Logger.getLogger(CatBien.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
